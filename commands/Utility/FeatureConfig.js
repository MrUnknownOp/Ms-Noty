...
module.exports = {
    ...
    callback: async(message, arguments, text) => {
        ...
        if(!OnFeature)
        {
            return message.reply("Please Provide a Valid Feature from(antiadvertise, event, antiswear, chatbot, antispam)!")
        }
        ...
        if(OnFeature.toLowerCase() === "antiadvertise")
        {
           ...
           message.reply( OnFeature +" has been enabled on this server!")
        ...
        } else if(OnFeature.toLowerCase() === "all")
        {
           ...
           message.reply( OnFeature +" Features has been enabled on this server!")
