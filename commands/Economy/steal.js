...
module.exports = {
  ...
  callback: async (message, arguments) => {
    ...
    if(!ans) return message.channel.send(`That user isn't in the database!`)

    if(ans.coins < 1000) 
    {
        return message.channel.send(`The user doesn't even have 1000 Noty(s), You can't steal anything from that guy.`)
    }
