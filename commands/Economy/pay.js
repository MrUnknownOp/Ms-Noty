...
module.exports = {
  ...
  callback: async (message, arguments, text) => {
    ...
    if(coinsToGive > ans.coins) return message.lineReply(`You don't have ${coinsToGive} Noty(s) to give!`)
   ...
   const remainingCoins = await profile.findOneAndUpdate(
     ...
     if(!newBalance)
     {
          return message.channel.send(`That user doesn't exist in the Database`);
     }
