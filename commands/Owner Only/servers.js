...
module.exports = {
    ...
    callback: (message, arguments, text, client) => {
      ...
      function emoji (id) {
        ...
        .addFields(
          {name: `${emoji("861945426445991976")} **Servers** :-` , value: `**${server}**!!` , inline : false},
          {name: `${emoji("861945426373640232")} **Channels** :-` , value: `**${dcchannel}**!!` , inline : false},
          {name: `${emoji("861945426827673622")} **Users** :-` , value: `**${user}**!!` , inline : false},
        )
        .setTimestamp()
        .setColor('RANDOM')
